...
export default {
    getTransferMarketData: (params?: { teamId?: string; playerName?: string; price?: string }) => {
    ...
    buyPlayer: (data: { playerId: number; inTeamId: number; outTeamId: number; price: number }) => post(`${apiUrl}/api/market/buy`, data),
}